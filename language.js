(() => {
  ...
  const translations = {
    fr: {
      ...
      'footer.tagline': 'L’excellence de la nature, inspirée par le Maroc.', 'footer.navigation': 'Navigation', 'footer.universes': 'Univers', 'footer.auth': 'Authenticité marocaine · Qualité premium', 'footer.more': '+ Plus',
    ...
    en: {
      ...
      'footer.tagline': 'Excellence from nature, inspired by Morocco.', 'footer.navigation': 'Navigation', 'footer.universes': 'Collections', 'footer.auth': 'Moroccan authenticity · Premium quality', 'footer.more': '+ More',
    ...
    ar: {
      ...
      'footer.tagline': 'تميّز الطبيعة، بإلهام من المغرب.', 'footer.navigation': 'التنقل', 'footer.universes': 'الفئات', 'footer.auth': 'أصالة مغربية · جودة راقية', 'footer.more': '+ المزيد',
  ...
  const selectorMap = {
    ...
    'nav.quality': '.main-nav a[href="#qualite"]',
    ...
    'footer.tagline': '.footer-brand > p', 'footer.navigation': '.footer-nav > div:first-child strong', 'footer.universes': '.footer-nav > div:last-child strong', 'footer.auth': '.footer-bottom > span:last-child',
