(() => {
  ...
  appendProducts('#epices .product-items', [['Cumin', 'CUMIN'], ['Gingembre', 'GINGEMBRE'], ['Paprika', 'PAPRIKA'], ['Curcuma', 'CURCUMA'], ['Cannelle', 'CANNELLE'], ['Cayenne', 'CAYENNE'], ['Poivre noir', 'POIVRE NOIR'], ['Poivre blanc', 'POIVRE BLANC'], ['Cardamome', 'CARDAMOME'], ['Clous de girofle', 'CLOUS DE GIROFLE'], ['Muscade', 'MUSCADE'], ['Anis étoilé', 'ANIS ÉTOILÉ'], ['Laurier', 'LAURIER'], ['Origan', 'ORIGAN'], ['Thym', 'THYM'], ['Ail en poudre', 'AIL EN POUDRE'], ['Curry', 'CURRY'], ['Safran', 'SAFRAN'], ['Sumac', 'SUMAC'], ['Fenugrec', 'FENUGREC']], { tag: 'ÉPICES', description: 'Une référence aromatique sélectionnée pour apporter profondeur, couleur et caractère aux recettes.', weights: ['50 g', '100 g', '250 g', '500 g', '1 kg'] });

  appendProducts('#epicerie .product-items', [['Pois chiches', 'POIS CHICHES', 'Une référence essentielle pour les préparations traditionnelles et du quotidien.'], ['Lentilles', 'LENTILLES', 'Une base polyvalente pour les recettes familiales et professionnelles.'], ['Haricots blancs', 'HARICOTS BLANCS', 'Une référence généreuse adaptée à de nombreux usages culinaires.'], ['Haricots rouges', 'HARICOTS ROUGES', 'Une référence appréciée pour les préparations salées et professionnelles.'], ['Pois cassés', 'POIS CASSÉS', 'Une référence polyvalente pour les soupes, plats et préparations.'], ['Fèves', 'FÈVES', 'Une référence traditionnelle pour une cuisine généreuse et authentique.']], { tag: 'ÉPICERIE', weights: ['50 g', '100 g', '250 g', '500 g', '1 kg', '5 kg'] });

  appendProducts('#fruits-secs .product-items', [['Raisins secs', 'RAISINS SECS'], ['Abricots secs', 'ABRICOTS SECS'], ['Dattes', 'DATTES'], ['Figues', 'FIGUES'], ['Pruneaux', 'PRUNEAUX'], ['Cranberries', 'CRANBERRIES'], ['Goji', 'GOJI'], ['Mangue séchée', 'MANGUE SÉCHÉE'], ['Kiwi séché', 'KIWI SÉCHÉ'], ['Ananas séché', 'ANANAS SÉCHÉ'], ['Banane séchée', 'BANANE SÉCHÉE']], { tag: 'FRUITS SECS', description: 'Une référence naturellement gourmande, adaptée aux préparations et à la dégustation.', weights: ['50 g', '100 g', '250 g', '500 g', '1 kg', '5 kg'] });

  appendProducts('#noix-graines .product-items', [['Amandes', 'AMANDES'], ['Amande grillée', 'AMANDE GRILLÉE'], ['Amande effilée', 'AMANDE EFFILÉE'], ['Amande hachée', 'AMANDE HACHÉE'], ['Amande en poudre', 'AMANDE EN POUDRE'], ['Noix', 'NOIX'], ['Noix de cajou', 'NOIX DE CAJOU'], ['Pistaches', 'PISTACHES'], ['Noisettes', 'NOISETTES'], ['Sésame', 'SÉSAME'], ['Graines de tournesol', 'GRAINES DE TOURNESOL'], ['Graines de courge', 'GRAINES DE COURGE'], ['Graines de chia', 'GRAINES DE CHIA'], ['Pignons de pin', 'PIGNONS DE PIN'], ['Cacahuètes blanches', 'CACAHUÈTES BLANCHES'], ['Cacahuètes rouges', 'CACAHUÈTES ROUGES'], ['Cacahuètes grillées', 'CACAHUÈTES GRILLÉES'], ['Cacahuètes salées', 'CACAHUÈTES SALÉES'], ['Cacahuètes nature', 'CACAHUÈTES NATURE']], { tag: 'NOIX & GRAINES', description: 'Une référence délicate au profil naturellement généreux et raffiné.', weights: ['50 g', '100 g', '250 g', '500 g', '1 kg', '5 kg'] });

  appendProducts('#cereales .product-items', [['Riz', 'RIZ', 'Une référence essentielle, polyvalente et pensée pour différents usages culinaires.'], ['Riz blanc', 'RIZ BLANC', 'Un riz polyvalent à la texture légère, adapté aux préparations du quotidien.'], ['Riz jaune', 'RIZ JAUNE', 'Un riz au caractère généreux, apprécié pour sa couleur et sa présence dans l’assiette.'], ['Quinoa', 'QUINOA', 'Une référence essentielle, polyvalente et pensée pour différents usages culinaires.'], ['Pâtes', 'PÂTES', 'Une référence essentielle, polyvalente et pensée pour différents usages culinaires.'], ['Avoine', 'AVOINE', 'Une référence essentielle, polyvalente et pensée pour différents usages culinaires.']], { tag: 'CÉRÉALES · RIZ · PÂTES', weights: ['50 g', '100 g', '250 g', '500 g', '1 kg', '5 kg'] });

  appendProducts('#autres .product-items', [['Cacao en poudre', 'CACAO EN POUDRE', 'Une référence destinée aux préparations gourmandes, alimentaires et professionnelles.'], ['Noix de coco en poudre', 'NOIX DE COCO EN POUDRE', 'Une référence destinée aux préparations gourmandes, alimentaires et professionnelles.'], ['Levure', 'LEVURE', 'Une référence destinée aux préparations gourmandes, alimentaires et professionnelles.'], ['Couscous fin', 'COUSCOUS FIN', 'Une semoule de couscous fine, légère et adaptée aux préparations traditionnelles.'], ['Couscous moyen', 'COUSCOUS MOYEN', 'Une semoule de couscous de granulométrie moyenne, polyvalente et généreuse.'], ['Couscous complet', 'COUSCOUS COMPLET', 'Un couscous préparé à partir de blé dur complet, pour une référence plus rustique.'], ['Couscous multi-céréales', 'COUSCOUS MULTI-CÉRÉALES', 'Un couscous associant plusieurs céréales pour une texture et un profil plus variés.'], ['Torsades', 'TORSADES', 'Des pâtes en forme torsadée, idéales pour retenir sauces et préparations généreuses.'], ['Coquillettes', 'COQUILLETTES', 'Une pâte courte classique, pratique pour les préparations du quotidien.'], ['Spaghetti', 'SPAGHETTI', 'Une pâte longue et fine, adaptée aux recettes traditionnelles et aux sauces.'], ['Vermicelles', 'VERMICELLES', 'Des pâtes fines et légères, adaptées aux soupes, préparations et accompagnements.']], { tag: 'AUTRES', weights: ['50 g', '100 g', '250 g', '500 g', '1 kg', '5 kg'] });

  appendProducts('#cafe .product-items', [['Café moulu', 'CAFÉ MOULU', 'Un café torréfié puis moulu, pensé pour une préparation régulière et aromatique.'], ['Café en grains', 'CAFÉ EN GRAINS', 'Des grains torréfiés pour préserver la fraîcheur des arômes jusqu’à la mouture.'], ['Café 100 % Arabica', '100 % ARABICA', 'Un café Arabica au profil aromatique fin, équilibré et naturellement parfumé.'], ['Café Arabica & Robusta', 'ARABICA & ROBUSTA', 'Un assemblage équilibré entre rondeur, puissance et caractère.'], ['Café décaféiné', 'CAFÉ DÉCAFÉINÉ', 'Un café décaféiné conservant une expression aromatique riche et équilibrée.']], { tag: 'CAFÉ', weights: ['250 g', '500 g', '1 kg', '5 kg'] });

  function addFamilySections() {
    const anchor = $('#autres');
    if (!anchor || document.querySelector('.catalog-family-section')) return;
    const families = [
      { id: 'huiles', number: '08', title: 'Huiles', header: 'L’or du terroir', description: 'Des huiles emblématiques du terroir marocain, sélectionnées pour leur caractère et leur qualité.', items: [['Huile d’argan', 'HUILE D’ARGAN', 'Une huile de caractère au goût délicatement torréfié, emblématique du terroir du Souss.'], ['Huile d’olive', 'HUILE D’OLIVE', 'Une huile d’olive fruitée et équilibrée, pensée pour la cuisine quotidienne et les préparations méditerranéennes.']] },
      { id: 'amlou', number: '09', title: 'Amlou', header: 'Trésors du Souss', description: 'Une collection de pâtes à tartiner inspirées de l’amlou marocain : fruits secs torréfiés, miel et huile, dans un esprit généreux.', items: [['Amlou aux amandes', 'AMLOU AMANDES', 'La version traditionnelle, autour de l’amande torréfiée, du miel et de l’huile d’argan.'], ['Amlou aux cacahuètes', 'AMLOU CACAHUÈTES', 'Une version gourmande et généreuse aux cacahuètes grillées, miel et huile d’argan.'], ['Amlou aux noisettes', 'AMLOU NOISETTES', 'Une pâte aux notes naturellement pralinées, avec noisettes torréfiées, miel et huile.'], ['Amlou aux noix', 'AMLOU NOIX', 'Une interprétation riche et légèrement boisée autour de la noix, du miel et de l’huile.'], ['Amlou aux noix de cajou', 'AMLOU CAJOU', 'Une texture douce et crémeuse aux noix de cajou torréfiées, miel et huile.'], ['Amlou à la pistache', 'AMLOU PISTACHE', 'Une version raffinée à la pistache, pensée pour une finition plus délicate et gourmande.']] },
