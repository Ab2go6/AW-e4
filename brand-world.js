(() => {
  ...
  const heroSurface = document.querySelector('link[data-arraouaa-world-hero-surface]') || document.createElement('link');
  heroSurface.rel = 'stylesheet';
  heroSurface.href = 'world-hero-mineral.css?v=20260914a';
  heroSurface.dataset.arraouaaWorldHeroSurface = 'true';
  if (!heroSurface.parentNode) document.head.appendChild(heroSurface);
