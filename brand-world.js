(() => {
    ...
    footer.innerHTML = `
      <div class="footer-main">
        <div class="footer-brand">
          <a class="footer-logo" href="index.html" aria-label="ARAOUAA">
  ...
  function prepareLanguageControls() {
    document.querySelectorAll('.world-page .language-switcher').forEach(element => element.remove());
